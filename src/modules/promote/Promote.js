      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            ...
            <h1 className="d-flex justify-content-center ts-5 tw-light">Festival-Offer</h1>
          
            <img src={img} alt="not found" className="mt-5" style={{height:"400px",width:"100%"}} data-aos="flip-up"/>
